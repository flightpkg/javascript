...
if (subpkg.bin != null) {
  const executable = subpkg.bin.flightjs
  ...
  if (platform === 'win') {
    ...
    fs.writeFileSync(path.resolve(process.cwd(), 'flightjs'), 'This file intentionally left blank')
    pkg.bin.flightjs = 'flightjs.exe'
