...
- c92936158: The registry field is removed from the `resolution` object in `flightjs-lock.yaml`.
...
- 0373af22e: Always correctly update the "time" field in "flightjs-lock.yaml".
