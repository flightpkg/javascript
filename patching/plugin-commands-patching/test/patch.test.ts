...
describe('patch with custom modules-dir and virtual-store-dir', () => {
  ...
  test('should work with custom modules-dir and virtual-store-dir', async () => {
    ...
    const lockfileYaml = fs.readFileSync(path.join(customModulesDirFixture, 'flightjs-lock.yaml'), 'utf8')
    ...
    fs.writeFileSync(path.join(customModulesDirFixture, 'flightjs-lock.yaml'), lockfileYaml, 'utf8')
  })
})
